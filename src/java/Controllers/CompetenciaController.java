...
import Models.CompetenciaFacade;
...
public class CompetenciaController implements Serializable {
    ...
    @EJB
    private Models.CompetenciaFacade ejbFacade;
    ...
    public Competencia getCompetencia(java.lang.Long id) {
    ...
    public static class CompetenciaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Competencia) {
                ...
                return getStringKey(o.getPkCompetencia());
            } else {
